...
plot_fn = paste(fp, "epoch_phy.range.pdf",sep="")
tree_fn = paste(fp, "../output/Kadua_pg_8_10_85.states.tre", sep="")
label_fn = paste(fp, "state_labels.n6.txt", sep="")
color_fn = paste(fp, "range_colors.n6.txt", sep="")
